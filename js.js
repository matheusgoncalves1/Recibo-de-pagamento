function gerarrecibo() {
    ...
    document.getElementById('recibo_cpfpagador').innerHTML = document.getElementById('cpfpagador').value;
    ...
    document.getElementById('recibo_emissor').innerHTML = document.getElementById('emissor').value;
    ...
    document.getElementById('recibo_assinatura_emissor').innerHTML = document.getElementById('emissor').value;
    document.getElementById('recibo_cpfemissor').innerHTML = document.getElementById('cpfemissor').value;
...
const input = document.getElementById('cpfpagador')
...
const input1 = document.getElementById('cpfemissor')
